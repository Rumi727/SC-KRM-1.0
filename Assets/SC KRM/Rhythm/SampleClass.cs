...
namespace SCKRM.Rhythm.Sample
{
    class BeatValuePairList<T> : BeatValuePairList<T, BeatValuePair<T>> { }

    class BeatValuePairList<TValue, TPair> : List<TPair>, IBeatValuePairList<TValue, TPair> where TPair : IBeatValuePair<TValue>
    {
    ...
    abstract class BeatValuePairAniList<T> : BeatValuePairAniList<T, BeatValuePairAni<T>> { }

    abstract class BeatValuePairAniList<TValue, TPair> : BeatValuePairList<TValue, TPair>, IBeatValuePairList<TValue, TPair> where TPair : IBeatValuePairAni<TValue>
    {
    ...
    class BeatValuePairAniListFloat : BeatValuePairAniList<float>
    {
    ...
    class BeatValuePairAniListDouble : BeatValuePairAniList<double>
    {
    ...
    class BeatValuePairAniListVector2 : BeatValuePairAniList<JVector2>
    {
    ...
    class BeatValuePairAniListVector3 : BeatValuePairAniList<JVector3>
    {
    ...
    class BeatValuePairAniListVector4 : BeatValuePairAniList<JVector4>
    {
    ...
    class BeatValuePairAniListColor : BeatValuePairAniList<JColor>
    {
    ...
    class BeatValuePairAniListColor32 : BeatValuePairAniList<JColor32>
    {
    ...
    class BeatValuePairAniListRect : BeatValuePairAniList<JRect>
    {
    ...
    struct BeatValuePair<TValue> : IBeatValuePair<TValue>
    {
    ...
    struct BeatValuePairAni<TValue> : IBeatValuePairAni<TValue>
    {
        public double beat { get; set; }
        public TValue value { get; set; }
